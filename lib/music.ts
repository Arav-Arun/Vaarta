...
// Vaarta is played while listening hard to a second language and speaking it
// aloud into a microphone. The music is a room tone, not a soundtrack, so it
// sits well under a voice line rather than competing with one.
