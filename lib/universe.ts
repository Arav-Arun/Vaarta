...
export type SceneData = {
  ...
  annotated?: string;
  /**
   * Solid areas the player must walk around: building footprints, water,
   * walls, stalls, carts, furniture. Percent coordinates like everything else.
   *
   * Optional because saved worlds predate it — a scene without obstacles is
   * simply fully walkable, which is how the engine behaved before collision.
   */
  obstacles?: Rect[];
};
